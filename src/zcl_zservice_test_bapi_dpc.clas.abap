class ZCL_ZSERVICE_TEST_BAPI_DPC definition
  public
...
protected section.
  ...
  methods SALESORDERSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZSERVICE_TEST_BAPI_MPC=>TS_SALESORDER
    raising
  ...
  methods SALESORDERSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZSERVICE_TEST_BAPI_MPC=>TT_SALESORDER
...
CLASS ZCL_ZSERVICE_TEST_BAPI_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 17.05.2025 09:20:42 in client 800
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZSERVICE_TEST_BAPI_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA salesorderset_create_entity TYPE zcl_zservice_test_bapi_mpc=>ts_salesorder.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA salesorderset_get_entity TYPE zcl_zservice_test_bapi_mpc=>ts_salesorder.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZSERVICE_TEST_BAPI_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA salesorderset_get_entityset TYPE zcl_zservice_test_bapi_mpc=>tt_salesorder.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA salesorderset_update_entity TYPE zcl_zservice_test_bapi_mpc=>ts_salesorder.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
