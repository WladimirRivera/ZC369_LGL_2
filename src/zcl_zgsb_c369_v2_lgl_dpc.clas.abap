class ZCL_ZGSB_C369_V2_LGL_DPC definition
  public
...
protected section.
  ...
  methods SALESORDERSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZGSB_C369_V2_LGL_MPC=>TS_SALESORDER
    raising
  ...
  methods SALESORDERSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZGSB_C369_V2_LGL_MPC=>TT_SALESORDER
...
CLASS ZCL_ZGSB_C369_V2_LGL_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 17.05.2025 12:06:40 in client 800
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZGSB_C369_V2_LGL_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA salesorderset_create_entity TYPE zcl_zgsb_c369_v2_lgl_mpc=>ts_salesorder.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA salesorderset_get_entity TYPE zcl_zgsb_c369_v2_lgl_mpc=>ts_salesorder.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZGSB_C369_V2_LGL_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA salesorderset_get_entityset TYPE zcl_zgsb_c369_v2_lgl_mpc=>tt_salesorder.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA salesorderset_update_entity TYPE zcl_zgsb_c369_v2_lgl_mpc=>ts_salesorder.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
