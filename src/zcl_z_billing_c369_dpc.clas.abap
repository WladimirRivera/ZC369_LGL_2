class ZCL_Z_BILLING_C369_DPC definition
  public
...
CLASS ZCL_Z_BILLING_C369_DPC IMPLEMENTATION.
...
*&*   generated methods inside DPC subclass - ZCL_Z_BILLING_C369_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
...
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC subclass - ZCL_Z_BILLING_C369_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
...
*  DATA ls_invoiceheader  TYPE zcl_z_billing_c369_mpc=>ts_invoiceheader.
...
*Used for setting business data
*  DATA lt_invoiceheader TYPE zcl_z_billing_c369_mpc=>tt_invoiceheader.
