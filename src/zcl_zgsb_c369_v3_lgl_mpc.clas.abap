class ZCL_ZGSB_C369_V3_LGL_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZGSB_C369_V3_LGL_MPC======CP' ##NO_TEXT.
...
CLASS ZCL_ZGSB_C369_V3_LGL_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZGSB_C369_V3_LGL_SRV' ).
...
lo_action->bind_input_structure( iv_structure_name  = 'ZCL_ZGSB_C369_V3_LGL_MPC=>TS_PAYMENTSTATUS' ). "#EC NOTEXT
  endmethod.
...
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'CustomersToOrdersSet'                         "#EC NOTEXT
                                              ...
                                              iv_right_entity_set_name = 'Orders001Set'             "#EC NOTEXT
                                              iv_association_name      = 'CustomersToOrders' ).                                 "#EC NOTEXT
...
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'OrdersToPaymentsSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'Orders001Set'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'Payments001Set'             "#EC NOTEXT
                                              iv_association_name      = 'OrdersToPayments' ).                                 "#EC NOTEXT

 lo_association = model->create_association(
                            iv_association_name = 'so_country' "#EC NOTEXT
                            iv_left_type        = 'Customers' "#EC NOTEXT
                            iv_right_type       = 'CountryCollection' "#EC NOTEXT
                            iv_right_card       = '1' "#EC NOTEXT
                            iv_left_card        = '1'   "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'OrdersToPaymentsNav' "#EC NOTEXT
                                                              ...
                                                              iv_association_name = 'OrdersToPayments' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'OrdersToCustomerNav' "#EC NOTEXT
                                                              iv_abap_fieldname = 'ORDERSTOCUSTOMERNAV' "#EC NOTEXT
                                                              iv_association_name = 'CustomersToOrders' ). "#EC NOTEXT
* Navigation Properties for entity - Customers
lo_entity_type = model->get_entity_type( iv_entity_name = 'Customers' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'CustomToOrdersNav' "#EC NOTEXT
                                                              iv_abap_fieldname = 'CUSTOMTOORDERSNAV' "#EC NOTEXT
                                                              iv_association_name = 'CustomersToOrders' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGSB_C369_V3_LGL_MPC=>TS_BRFSHCUSTOMID' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGSB_C369_V3_LGL_MPC=>TS_CONFIRMORDER' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGSB_C369_V3_LGL_MPC=>TS_ORDERLIST' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZSORDER'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'Orders001Set' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'Payments001Set' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250531092237'.                  "#EC NOTEXT
