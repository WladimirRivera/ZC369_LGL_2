class ZCL_ZSGWB_FLIGHTS_C_05_MPC definition
  public
...
CLASS ZCL_ZSGWB_FLIGHTS_C_05_MPC IMPLEMENTATION.
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250628091825'.                  "#EC NOTEXT
...
*&---------------------------------------------------------------------*
*    @@TYPE_SWITCH:
    CONSTANTS: co_gen_date_time TYPE timestamp VALUE '20250628131826'.
    TRY.
  ...
  method IF_SADL_GW_MODEL_EXPOSURE_DATA~GET_MODEL_EXPOSURE.
    CONSTANTS: co_gen_timestamp TYPE timestamp VALUE '20250628131826'.
    DATA(lv_sadl_xml) =
