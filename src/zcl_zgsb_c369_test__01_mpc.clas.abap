class ZCL_ZGSB_C369_TEST__01_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZGSB_C369_TEST__01_MPC====CP' ##NO_TEXT.
...
CLASS ZCL_ZGSB_C369_TEST__01_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZGSB_C369_TEST_LGL_SRV_01' ).
...
lo_action->bind_input_structure( iv_structure_name  = 'ZCL_ZGSB_C369_TEST__01_MPC=>TS_PAYMENTSTATUS' ). "#EC NOTEXT
  endmethod.
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'OrdersToCustomers' "#EC NOTEXT
                                                              iv_abap_fieldname = 'ORDERSTOCUSTOMERS' "#EC NOTEXT
                                                              iv_association_name = 'CustomersToOrders' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGSB_C369_TEST__01_MPC=>TS_BRFSHCUSTOMID' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGSB_C369_TEST__01_MPC=>TS_CONFIRMORDER' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGSB_C369_TEST__01_MPC=>TS_ORDERLIST' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250531075250'.                  "#EC NOTEXT
