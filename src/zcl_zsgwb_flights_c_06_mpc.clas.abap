class ZCL_ZSGWB_FLIGHTS_C_06_MPC definition
  public
...
public section.
  ...
  types:
    begin of TS_ZI_SCARRTYPE.
      include type ZI_SCARR.
  types:
    end of TS_ZI_SCARRTYPE .
  types:
   TT_ZI_SCARRTYPE type standard table of TS_ZI_SCARRTYPE .

  constants GC_FLIGHTTYPE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'FlightType' ##NO_TEXT.
  constants GC_ZI_SCARRTYPE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ZI_SCARRType' ##NO_TEXT.
...
CLASS ZCL_ZSGWB_FLIGHTS_C_06_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZSGWB_FLIGHTS_C369_V3_SRV' ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250628101740'.                  "#EC NOTEXT
...
*&---------------------------------------------------------------------*
*    @@TYPE_SWITCH:
    CONSTANTS: co_gen_date_time TYPE timestamp VALUE '20250628141741'.
    TRY.
  ...
  method IF_SADL_GW_MODEL_EXPOSURE_DATA~GET_MODEL_EXPOSURE.
    CONSTANTS: co_gen_timestamp TYPE timestamp VALUE '20250628141741'.
    DATA(lv_sadl_xml) =
   ...
   ro_model_exposure = cl_sadl_gw_model_exposure=>get_exposure_xml( iv_uuid      = CONV #( 'ZSGWB_FLIGHTS_C369_V3' )
