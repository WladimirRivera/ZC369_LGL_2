class ZCL_ZGSB_C369_LGL_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZGSB_C369_LGL_MPC=========CP' ##NO_TEXT.
...
CLASS ZCL_ZGSB_C369_LGL_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZGSB_C369_LGL_SRV' ).
...
lo_action->bind_input_structure( iv_structure_name  = 'ZCL_ZGSB_C369_LGL_MPC=>TS_PAYMENTSTATUS' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGSB_C369_LGL_MPC=>TS_BRFSHCUSTOMID' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGSB_C369_LGL_MPC=>TS_CONFIRMORDER' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGSB_C369_LGL_MPC=>TS_ORDERLIST' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250524104554'.                  "#EC NOTEXT
